...
namespace Studievereniging.Controllers
{
    public class ActivitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,StartDate,EndDate,Location,MaxParticipants,Price,RegistrationDeadline,Category,Calendar,Image,IsPublic,AdminId")] Activity activity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,StartDate,EndDate,Location,MaxParticipants,Price,RegistrationDeadline,Category,Calendar,Image,IsPublic,AdminId")] Activity activity)
        {
            if (id != activity.Id)
            {
                return NotFound();
